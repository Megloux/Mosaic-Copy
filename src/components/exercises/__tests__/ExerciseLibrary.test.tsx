    ...
    exercises: [
      {
        ...
        vimeo_id: '12345',
        standard_time: '30s',
        muscle_tags: ['Core', 'Abs'],
        visual_cue: 'Draw navel to spine, keep shoulders stable',
        setup_cues: ['Start in forearm plank position with knees down'],
        movement_cues: ['Maintain neutral spine, engage core'],
        breathing_cues: { exhale: 'On exertion', inhale: 'On release' },
        common_mistakes: ['Dropping hips'],
        easier_modification: 'Keep knees down',
        harder_progression: 'Lift knees',
      },
      {
        id: 'e2',
        ...
        vimeo_id: '23456',
        standard_time: '45s',
        muscle_tags: ['Obliques', 'Core'],
        visual_cue: 'Lift hips, maintain straight line',
        setup_cues: ['Start on side with forearm on mat'],
        movement_cues: ['Stack shoulders and hips'],
        breathing_cues: { exhale: 'Lift hips', inhale: 'Lower' },
        common_mistakes: ['Hips sagging'],
        easier_modification: 'Bend bottom knee',
        harder_progression: 'Add leg lift',
      },
    ],
    categories: [
      { id: 'c1', name: 'Abs' },
