...
function setupBackgroundSync(registration: ServiceWorkerRegistration) {
  ...
  if ('sync' in registration && typeof (registration as any).sync !== 'undefined') {
    ...
    window.addEventListener('online', () => {
      ...
      if (
        ...
        typeof (registration.sync as any).register === 'function'
      ) {
        (registration.sync as any).register('sync-routines')
          .then(() => {
